...
##### TEST 4  STRAIN-DENSITY_MELTING POINT #####
        ...
        new_list = []
        new_list.append(dop_conduct)
        new_list.append(temp_conductivity)
        new_list.append(mp_conduct)
        new_list.append(pres_conduct)
...
### TEST 5 - GRAPH PLOTING
        ...
        plt.plot(['dop_conduct', 'temp_conductivity', 'mp_conduct', 'pres_conduct'],
                 [new_list[0], new_list[1], float(new_list[2]), new_list[3]],
        ...
        for i, txt in enumerate([float(new_list[0]), float(new_list[1]), float( new_list[2]),float(new_list[3])]):
